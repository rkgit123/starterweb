...
<div id="page" class="hfeed site">
	...
	<?php if ( get_header_image() && $himage == '' ) : ?>
		<?php if ( get_theme_mod('moesia_banner') == 1 && !is_front_page() ) : ?>
			<header id="masthead" class="site-header" role="banner" style="max-height: 500px !important;">
		<?php else : ?>
			<header id="masthead" class="site-header has-banner" role="banner" style="max-height: 500px !important;">
			<?php if ( get_theme_mod('mobile_header') ) : ?>
				<img class="header-image" style="max-height: 500px !important;" src="<?php echo esc_url( get_theme_mod('mobile_header') ); ?>">
			<?php else : ?>
				<img class="header-image" style="max-height: 500px !important;" src="<?php echo esc_url(get_header_image()); ?>">
			<?php endif; ?>
		<?php endif; ?>
	...
	<?php elseif ( $himage != '' ) : ?>	
		<header id="masthead" class="site-header has-banner" role="banner" style="max-height: 500px !important;">
			<img class="header-image" style="max-height: 500px !important;" src="<?php echo esc_url($himage); ?>">
			<div class="welcome-info">
				<?php if ( $htitle ) : ?>
