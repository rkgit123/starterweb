 ...
 */
    ...
    if (oldIE) {
         alert('Você esta usando uma versão antiga do Internet Explore que contem erros se segurança, por favor atualize seu navegador.\n Caso tenha alguma duvida pesquise a respeito, Obrigado.');
    } else {
